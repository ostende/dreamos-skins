...
cp -rf /tmp/dreamos-skins-main/ostende-dreamskins/Zombi-Shadow-FHD /usr/share/enigma2/Zombi-Shadow-FHD > /dev/null 2>&1
cp -rf /tmp/dreamos-skins-main/ostende-dreamskins/renderers/* /usr/lib/enigma2/python/Components/Renderer/ > /dev/null 2>&1
rm -rf /tmp/dreamos-skins-main* > /dev/null 2>&1
